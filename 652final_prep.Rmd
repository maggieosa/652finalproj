...
#multiple error bars, density stripes according to color 
```
...
#fill for the bar according to axis (groups)
#probably only need y axis gridlines
```
...
#ggplotly basic interactions- highlights over a certain line - INTERACTIVE Graph not animated
#patchwork package (have an overall title rather than individual title)
#use ggprepel to make sure that it points  to the line 
#create new df, filter to have only the end points (2015)
